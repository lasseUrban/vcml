 ...
 ********************************************************************************/
    ...
    EXPECT_TRUE(sdhci.IRQ.is_set());                                    // check whether an interrupt has been triggered
 ...
 ********************************************************************************/
    ...
    vcml::u64 mem0;
    vcml::u64 mem1;
    host_system.mem.read(vcml::range(0x00000010, 0x00000017), &mem0, 0);
    host_system.mem.read(vcml::range(0x00000018, 0x0000001F), &mem1, 0);
 ...
 ********************************************************************************/
    ...
    host_system.mem.write(vcml::range(0x00000040, 0x00000047), &mem0, 0);
    host_system.mem.write(vcml::range(0x00000048, 0x0000004F), &mem1, 0);
 ...
 ********************************************************************************/
        ...
        EXPECT_THROW(sc_core::sc_start(quantum), std::exception);           // expect that an exception is thrown
 ...
 ********************************************************************************/
        ...
        EXPECT_ANY_THROW(host_system.OUT.writew(0x20, 0x0001));             // expect that an exception is thrown
